...
- **Mirage variable as single font family** (Play New design system). One family for display, body, and the historical "mono" role. License to be verified before public redistribution; if dropped, design system falls back to system-ui per the chain in `design.py`.
