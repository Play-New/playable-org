...
- **mcp-server/** — TypeScript stdio mcp server. Thirteen tools, full e2e suite at `mcp-server/test-e2e.py` (252/252 pass, covering pipeline tests + design-regression checks for each viewer), ~30KB compiled.
